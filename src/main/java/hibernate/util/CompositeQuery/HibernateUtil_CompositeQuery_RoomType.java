...
public class HibernateUtil_CompositeQuery_RoomType {

	public static Predicate get_aPredicate_For_AnyDB(CriteriaBuilder builder, Root<RoomType> root, String columnName, String value) {
...
//			predicate = builder.equal(root.get("deptVO"), deptVO);
	...
	public static List<RoomType> getAllC(Map<String, String[]> map, Session session) {
