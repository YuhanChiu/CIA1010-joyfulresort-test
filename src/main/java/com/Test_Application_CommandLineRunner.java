...
//		roomType.setEname("吳永志1");
//		roomType.setJob("MANAGER");
//		roomType.setHiredate(java.sql.Date.valueOf("2005-01-01"));
//		roomType.setSal(new Double(50000));
//		roomType.setComm(new Double(500));
//		roomType.setDeptVO(deptVO);
